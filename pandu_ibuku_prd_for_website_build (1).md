...
## 17) Visual Spec Appendix

This appendix provides **concrete visual specifications** to remove ambiguity during implementation. These are recommendations, not hard dependencies, but deviations should be justified against the editorial principles.

---

### 17.1 Font Candidates (Choose ONE primary family)

All options below are chosen for long-form readability, calm authority, and editorial tone. Use **one family consistently** across body text and headings where possible.

**Option A — Serif (Primary Recommendation)**
- Character: Editorial, timeless, excellent for long reading
- Usage:
  - Body text: Regular
  - Headings: Medium / Semi-Bold
- Rationale: Feels closest to book typography and reflective writing

**Option B — Humanist Serif (Balanced)**
- Character: Slightly more modern, still warm and readable
- Usage:
  - Body text: Regular
  - Headings: Medium
- Rationale: Good balance between engineering rationality and editorial calm

**Option C — Humanist Sans-Serif (Alternative)**
- Character: Rational, clean, engineer-forward
- Usage:
  - Body text: Regular
  - Headings: Medium
- Rationale: Acceptable if a serif feels too traditional, but must remain restrained
...
### 17.2 Recommended Type Sizes

(All sizes assume desktop base; mobile should scale proportionally.)

- **Body text:** 18–19 px
- **Line height (body):** 1.6–1.7
- **H1 (article title):** 36–40 px
- **H2:** 26–28 px
- **H3:** 20–22 px
- **Metadata (date, category):** 13–14 px

Rules:
- Prioritize comfortable reading over compactness
- Titles should never feel aggressive or oversized

---

### 17.3 Spacing & Layout Rules
...
- Minimum side margins:
  - Desktop: 10–15% of viewport width
  - Tablet: 8–10%
  - Mobile: consistent internal padding (no edge-to-edge text)

**Paragraph spacing**
- Space between paragraphs preferred over text indentation

Rule:
Whitespace is intentional and should never be aggressively reduced.

---

### 17.4 Color Specifications (Exact Hex Values)
...
**Accent color (links, subtle emphasis)**
- Muted navy: `#1F2F4A`

**Divider / subtle borders (optional)**
- Light neutral gray: `#E6E4E1`
...
### 17.5 Logo Placement & Sizing

- Logo appears as typographic masthead in header
- Default header logo height:
  - Desktop: 36–42 px
  - Mobile: 28–32 px

- Maintain generous space above and below logo
- Logo color:
  - Primary: Charcoal (`#1F1F1F`)
  - Optional secondary: Muted navy (`#1F2F4A`) for “Ibuku” only

---

### 17.6 Final Design Check

Before approving any page, confirm:
- Text is comfortable to read for extended periods
- No visual element competes with the content
- Color usage is restrained and consistent
- Typography feels calm, not promotional

If uncertain, reduce visual intensity rather than add.
